...
public class LoginWebDataProvider {
  ...
  public String[] [] dataProviderMethod() 
  {
	...
	@Test(dataProvider="logincreds", dataProviderClass= testNGDataProvider.LoginWebDataProvider.class)
